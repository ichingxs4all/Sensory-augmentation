void readSensors(){
  ...
  int sensora = map(SENSORA_Filter.Current(),minValueSensorA,maxValueSensorA,0,level);
  int sensorb = map(SENSORB_Filter.Current(),minValueSensorB,maxValueSensorB,0,level);
