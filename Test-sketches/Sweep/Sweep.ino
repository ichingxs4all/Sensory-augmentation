...
void setup() {
	...
	myservoA.attach(servoAPin, 1000, 2000); // attaches the servo on pin 18 to the servo object
	myservoB.setPeriodHertz(50);    // standard 50 hz servo
	myservoB.attach(servoBPin, 1000, 2000); // attaches the servo on pin 18 to the servo object
